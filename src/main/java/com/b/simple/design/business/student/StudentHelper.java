...
public class StudentHelper {
	...
	private static final int GRADE_B_LOWER_LIMMIT = 51;
	private static final int GRADE_B_UPPER_LIMMIT = 80;
	private static final int EXTRA_FOR_LIMIT = 10;
	/* PROBLEM 1 */	
	/*
	...
	public boolean isGradeB(int marks, boolean isMaths) {
		...
		int extraLimit = isMaths ? EXTRA_FOR_LIMIT : 0;
		int upperLimit= GRADE_B_UPPER_LIMMIT+extraLimit;

		return  marks>=GRADE_B_LOWER_LIMMIT && marks<=upperLimit ;
